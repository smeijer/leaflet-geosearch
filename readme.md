...
`Bing`, `Esri`, `Google`, `LocationIQ` or `HereMap` providers. Those providers do however require API 
...
## HereMap Provider 
**note**: HereMap services require an APP_ID and APP_CODE keys. [Obtain here][20].
For more options and configurations, see the [HereMaps developer docs][21].

```js
import { HereMapProvider } from 'leaflet-geosearch';
...
[20]: https://developer.here.com
[21]: https://developer.here.com/documentation
